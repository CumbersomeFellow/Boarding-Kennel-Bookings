...
namespace BoardingKennelBookings.Migrations
{
    ...
    [Migration("20260910122535_AddBookingDogKennel")]
    partial class AddBookingDogKennel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BookingKennel", b =>
                {
                    ...
                    b.Property<int>("KennelsKennelID")
                        .HasColumnType("int");

                    b.HasKey("BookingsBookingID", "KennelsKennelID");
            ...
            modelBuilder.Entity("BookingKennel", b =>
                {
                    ...
                    b.HasOne("BoardingKennelBookings.Components.Models.Kennel", null)
                        .WithMany()
                        .HasForeignKey("KennelsKennelID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
